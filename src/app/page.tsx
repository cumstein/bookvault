...
export default function Home() {
  return (
    <section className="flex flex-col justify-center items-center text-center py-20 space-y-6 max-w-2xl mx-auto">
      ...
      <Button
        asChild
        className="relative overflow-hidden px-8 py-4 rounded-xl text-lg font-semibold bg-gradient-to-r from-primary to-secondary text-white shadow-lg transition-transform duration-300 hover:scale-105 hover:from-secondary hover:to-primary group"
      >
